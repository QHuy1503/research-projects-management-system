            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 mb-4 custom_table_ttdetai">
                        ...
                        <?php
                            $sql = "SELECT detaigiangvien.*, HoTenGV
                                    FROM detaigiangvien JOIN giangvien ON detaigiangvien.CoVan = giangvien.MaGiangVien
                                    WHERE MaDeTaiGV = '".$maDeTai."'"; //
                            if ($result = mysqli_query($conn,$sql))
                            {
                                while ($row=mysqli_fetch_row($result))
                    ...
                    <br> 
                    <div class="col-lg-6 col-md-12 col-12 mb-4 ">
                        <h5>Danh sách giảng viên thực hiện đề tài</h5>
                        <table class="custom_table table table-hover">
                            <thead>
                                <tr>
                        ...
                        <?php
                            $sql = "SELECT nhomgv.MaNhomGV, nhomgv.MaGiangVien, HoTenGV, VaiTro
                                    FROM detaigiangvien JOIN nhomgv ON detaigiangvien.MaNhomGV = nhomgv.MaNhomGV JOIN giangvien ON nhomgv.MaGiangVien = giangvien.MaGiangVien
                                    WHERE MaDeTaiGV = '".$maDeTai."'"; //
                            if ($result = mysqli_query($conn,$sql))
                            {
                                while ($row=mysqli_fetch_row($result))
                        ...
                        <?php
                            $sql = "SELECT isNghiemThu, MaHoiDong, NgayNghiemThu, Diem, DanhGia
                                    FROM detaigiangvien JOIN nghiemthudtgv ON detaigiangvien.MaDeTaiGV = nghiemthudtgv.MaDeTaiGV
                                    WHERE detaigiangvien.MaDeTaiGV = '".$maDeTai."'"; //
                            if ($result = mysqli_query($conn,$sql))
                            {
                                while ($row=mysqli_fetch_row($result))
                                {

<?php
    ...
    $sql = "INSERT INTO nghiemthudtgv (MaDeTaiGV, MaHoiDong, NgayNghiemThu, Diem, DanhGia, FileBaoCao) VALUES (?,?,?,?,?,?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $madetai, $mahoidong, $ngaynghiemthu, $diem, $danhgia, $fileBC);
    
    $sql2 = "UPDATE detaigiangvien SET isNGhiemThu = 1 WHERE MaDeTaiGV = ?";
